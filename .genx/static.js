...
const DIRS_MAP = new Map([
  ...
  [DIR_TEMPLATE_ANGULAR_ALIAS, `${DIR_TEMPLATE_ROOT_ALIAS}/${DIR_TEMPLATE_ANGULAR_ALIAS}`],
  [DIR_TEMPLATE_WEB_COMPONENT_ALIAS, `${DIR_TEMPLATE_ROOT_ALIAS}/${DIR_TEMPLATE_WEB_COMPONENT_ALIAS}`],
  [DIR_TEMPLATE_REACT_ALIAS, `${DIR_TEMPLATE_ROOT_ALIAS}/${DIR_TEMPLATE_REACT_ALIAS}`],
]);

const DIR_TEMPLATE_BY_FRAMEWORK = {
  [FRAMEWORK_WEB_COMPONENTS_ALIAS]: DIRS_MAP.get(DIR_TEMPLATE_WEB_COMPONENT_ALIAS),
