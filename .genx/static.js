...
const TEXTS = {
  INTRO_API_HOST: 'You can override the default Genesis server URL used during local developent.',
  INTRO_API_SSO: 'Optionally, you can enable the SSO function, which will redirect to identity provider before starting the application (given we only have one identity provider).',
  ...
  MESSAGE_SERVER_CSV: 'Generate empty CSV for entities? (config in JSON format)',
