...
{{#if AI.enabled}}
        ...
        // never here, where it would live in source control. AI_ALLOWED_MODELS lists the models the
        // chat may ask for (empty refuses every model), and AI_MAX_OUTPUT_TOKENS caps the output size
